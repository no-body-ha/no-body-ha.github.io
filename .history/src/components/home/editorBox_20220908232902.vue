  ...
  mounted() {
    ...
    document.onmousedown = (e) => {
      ...
      if (
        ...
        if (e.path.style.textAlign == "left") {
          Middleware.$emit("AlignLeft", true);
        } else if (e.path.style.textAlign == "center") {
          Middleware.$emit("Center", true);
        } else if (e.path.style.textAlign == "right") {
          Middleware.$emit("AlignRight", true);
        }
        Middleware.$emit(
          "fontColor",
          e.path.style.color || e.path.style.fontColor || "#000000"
        );
        Middleware.$emit(
          "highColor",
          e.path.style.backgroundColor ||
            e.path.style.background ||
            "rgba(255, 255, 255, 1)"
        );
