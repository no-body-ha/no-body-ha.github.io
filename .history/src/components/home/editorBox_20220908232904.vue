  ...
  mounted() {
    ...
    document.onmousedown = (e) => {
      ...
      if (
        ...
        if (e.path[0].style.textAlign == "left") {
          Middleware.$emit("AlignLeft", true);
        } else if (e.path[0].style.textAlign == "center") {
          Middleware.$emit("Center", true);
        } else if (e.path[0].style.textAlign == "right") {
          Middleware.$emit("AlignRight", true);
        }
        Middleware.$emit(
          "fontColor",
          e.path[0].style.color || e.path[0].style.fontColor || "#000000"
        );
        Middleware.$emit(
          "highColor",
          e.path[0].style.backgroundColor ||
            e.path[0].style.background ||
            "rgba(255, 255, 255, 1)"
        );
